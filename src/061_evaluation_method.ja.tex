...
動画については、利用者数の多いYouTube\cite{youtube}/Amazon Prime Video\cite{amazon-prime-video}/TVer\cite{tver}/Netflix\cite{netflix}/GYAO!\cite{gyao}/Hulu\cite{hulu}/ABEMA\cite{abema}で再生位置が復元することを評価する。
...
オーディオブックのAudible\cite{audible}で音声の再生位置が復元するかどうか検証する。
